...
public class ReporterLib {
	...
	void generateFooterDetails(PrintWriter m_out) throws UnknownHostException {
		...
		m_out.println("<Table><Hr><I>Charles Hudson Automation Team</I>");
	}
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println("<head>");
		out.println("<title>Charles Hudson Automation Report</title>");
		...
		out.println("</head>");
		out.println("<body>");
		out.println("<h3>DXL Automation Execution Report</h3>");
	}
	...
	public String ArchiveFile(String outdir, String strResultFile) {
		...
		File destination1 = new File(targetDir + "\\CH_Automation-TestReport" + formatDate.format(Time) + ".html");
		try {
